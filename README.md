...
2. Pre-requists
We need Node & wrangler to be installed:
...
3. Following is the infra we'll need :
    ...
    2. D1 SQL database
        ...
        - In cloudflare dashboard, goto 'Storage & Database' -> 'D1 SQ DataBase' -> Click on '+Create Database', enter name -> Click 'Create'
          - 4 tables in the database: users, artworks, artwork_images, audit_log
    ...
    5. Create Pages and Function using wrangler:
        - Make sure you are in root dir of project and NOT in local. Run following commands:
            npx wrangler login
